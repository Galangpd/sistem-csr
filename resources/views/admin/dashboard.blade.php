...
<div class="p-4 mt-0">
    <div class="md:flex md:justify-between">
        <h1 class="font-bold font-blue-500 text-[20px] md:text-md lg:text-xl xl:text-2xl text-black">Dashboard</h1>
    </div>
</div>

<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
  <div class="flex items-center space-x-3 rounded-2xl border border-slate-300 shadow-lg bg-blue-600 p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
    <div class="flex h-15 w-15 items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800">
      <i class="fa-regular fa-building text-2xl text-gray-500"></i>
    </div>

    <div>
        <span class="text-xl text-white dark:text-gray-400 font-bold">Perusahaan</span>
        <h4 class="mt-2 text-2xl font-bold text-white dark:text-white/90">
          {{ $perusahaan }}
        </h4>
    </div>
  </div>
  ...
  <div class="flex items-center space-x-3 rounded-2xl border border-slate-300 shadow-lg bg-orange-500 p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
    <div class="flex h-15 w-15 items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800">
    ...
    <div>
        <span class="text-xl text-white dark:text-gray-400 font-bold">Kelompok Masyarakat</span>
        <h4 class="mt-2 text-2xl font-bold text-white dark:text-white/90">
          {{ $masyarakat }}
        </h4>
    </div>
