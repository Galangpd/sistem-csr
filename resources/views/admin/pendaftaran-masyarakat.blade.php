...
<div class="p-4">
    <div class="md:flex md:justify-between">
        <h1 class="font-bold text-[20px] md:text-md lg:text-xl xl:text-2xl text-black">Daftar Pendaftaran Pengguna Masyarakat</h1>
    </div>
</div>

<div class="card">
    <div class="max-w-full mx-auto mb-5">
        <form method="GET" action="{{ route('register.masyarakat.admin') }}">   
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                    ...
                    <td class="px-6 py-4 text-center flex justify-center items-center">
                        @if ($item->status == 'pending')
                            <a href="{{ route('detail.masyarakat.admin', $item->masyarakat->id) }}">
