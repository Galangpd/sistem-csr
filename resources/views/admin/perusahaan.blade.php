...
<div class="card">
    <div class="max-w-full mx-auto">
        <form method="GET" action="{{ route('perusahaan.admin') }}">   
            ...
            <div class="relative">
                ...
                <input onchange="this.form.submit()" name="search" value="{{ request()->search }}" type="search" id="search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Cari Perusahaan"  />
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                    ...
                    <td class="px-6 py-4">
                        <a href="{{ route('detail.perusahaan.admin', $item['id']) }}">
