...
@section('konten')
    ...
    <div class="relative w-full mx-auto bg-white pb-10 px-10 flex flex-col lg:flex-row items-center h-full lg:h-screen overflow-hidden">
        ...
        <div class="w-full lg:w-1/2 mt-32 lg:mt-10 mb-0 flex justify-center z-20">
            <img src="{{ asset('asset/home2.png') }}" alt="Ilustrasi CSR" class="w-64 h-64 md:w-1/2 md:h-1/2 lg:w-3/4 lg:h-3/4 object-contain">
        </div>

        <div class="w-full lg:w-1/2 space-y-6 me-5 z-20 mb-20 lg:mb-0">
            ...
            <div class="mt-2 flex lg:order-2 space-x-3 lg:space-x-0">
                    <a href="/login"
